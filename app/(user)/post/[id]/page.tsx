        ...
        {post.coverImage?.asset && (
            <div className="relative h-[50vh] w-full bg-gray-100">
                ...
                <div className="absolute inset-0 overflow-hidden">
                     <Image src={urlFor(post.coverImage).url()} alt={post.coverImage.alt || post.title || "Post cover Image"} fill className="object-contain blur-md scale-105 brightness-90" priority/>
                
                </div>
                {/* Clear Centered Image */}
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative w-full max-w-3xl h-full max-h-[400px] mx-4">
                         <Image src={urlFor(post.coverImage).url()} alt={post.coverImage.alt || post.title || "Post cover Image"} fill className="object-contain " priority/>
                    </div>
