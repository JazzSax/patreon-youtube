        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 sm:p-8 bg-gradient-to-r from-indigo-500 to-purple-600">
            ...
            <p className="text-indigo-100">
              As a VIP member, you can send direct messages to the creator.
              Please be respectful and concise in your messages.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                ...
                onKeyDown={(e) => {
                  if (
                    ...
                    if (featureUsageExceeded) {
                      toast.error(
                        "Feature usage exceeded. Please try again later.",
                      );
                      e.preventDefault();
                      return;
                    }
            ...
            <div className="pt-4">
              <Button
                type="submit"
                disabled={
                  isSending || schematicIsPending || featureUsageExceeded
                }
                className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700"
              >
                {isSending ? (
